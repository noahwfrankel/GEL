...
export function SpotifyLoginButton() {
  ...
  return (
    <button
      type="button"
      onClick={handleLogin}
      className="flex h-[52px] w-full items-center justify-center gap-3 rounded-xl bg-[#1DB954] font-semibold text-white transition hover:bg-[#1ed760] duration-200 focus:outline-none focus:ring-2 focus:ring-[#1DB954] focus:ring-offset-2 focus:ring-offset-[#0a0a0a]"
